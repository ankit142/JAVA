...
static String [][]answers ={{"FEBRUARY\n","SEPTEMBER\n","march\n","january\n"},{"Melting\n"," \nEvaporation","Freezing\n"," \nSolidifying\n"},{" \n8\n"," \n10\n"," \n6\n"," \n4\n"},{" \nSaturn\n"," \nNeptune\n"," \nUranus\n"," \nJupiter\n"},{" \nElephant\n"," \nTiger\n"," \nCheetah\n"," \nHumans\n"} };
static int []n = {2,1,1,1,1};
static String []choice= {"1","2","1","1","3"};
...
public class test extends JFrame{
    static String studentname="Ankit";
    static int TOTAL=0;
...
**/
    public Northwindow(){
		...
		student = new JLabel("\t Welcome : "+studentname+" to the Test");
